-- PROJETO DE ACOMPANHAMENTO DE VENDAS
...
select 
   ...
   (payments.receita / 1000)::int as "receita (k, R$)", 
   (payments.paid_count * 100 / leads.visit_page_count)::int as "conversão (%)", 
   (payments.receita / payments.paid_count / 1000)::int as "ticket médio (k, R$)" 
from leads
left join payments
